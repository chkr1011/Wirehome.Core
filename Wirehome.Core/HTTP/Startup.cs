...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        var mvcBuilder = services.AddMvc(o => { o.Filters.Add(new DefaultExceptionFilterAttribute()); });

        mvcBuilder.AddNewtonsoftJson(o => { o.SerializerSettings.Converters.Add(new StringEnumConverter()); });
    ...
    static void ConfigureWebApps(IApplicationBuilder app, GlobalVariablesService globalVariablesService, PackageManagerService packageManagerService, MqttService mqttService)
    {
    ...
    static void ExposeDirectory(IApplicationBuilder app, string requestPath, IFileProvider fileProvider)
    {
        ...
        fileServerOptions.StaticFileOptions.OnPrepareResponse = context => { context.Context.Response.Headers["Cache-Control"] = "public, max-age=60"; };
