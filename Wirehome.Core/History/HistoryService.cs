...
public sealed class HistoryService : WirehomeCoreService
{
    ...
    public HistoryService(StorageService storageService, SystemStatusService systemStatusService, DiagnosticsService diagnosticsService, ILogger<HistoryService> logger)
    {
    ...
    public Task<HistoryExtract> BuildHistoryExtractAsync(string path,
        DateTime rangeStart,
        DateTime rangeEnd,
        TimeSpan? interval,
